...
uint8_t decodePOS(uint16_t *m, uint32_t pkkoffs, uint32_t pkkpulselevel) {
...
uint8_t decodeZERO8(uint16_t *m, uint32_t pkkoffs, uint32_t pkkpulselevel) {
